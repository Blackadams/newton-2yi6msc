...
> Be patient! In ~3 mins your app is live, at your [app url](https://newton-2yi6msc.newton.wiki/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://newton-2yi6msc.newton.wiki/
...
```
git clone git@github.com:Blackadams/newton-2yi6msc.git
```
